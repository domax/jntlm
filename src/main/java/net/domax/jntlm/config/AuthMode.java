 ...
 *
 * <p>Each mode maps to the {@code hashNt}/{@code hashLm}/{@code hashNtlm2} switches on {@link
 * Credentials} exactly as CNTLM does in {@code main.c} (the {@code magic_auth_detect} / {@code
 * Auth} parsing section).
 */
