...
/**
 * Outcome of {@link RequestForwarder#forward}, mirroring the three return states of CNTLM's
 * {@code forward_request}:
 * <ul>
 *   <li>{@link #close()} &mdash; the client connection must be closed (CNTLM {@code return -1});</li>
 *   <li>{@link #done()} &mdash; the request/response cycle completed and the client connection may
 *       be kept alive (CNTLM {@code return NULL});</li>
 ...
 *       caller re-forwards it on a fresh connection (CNTLM {@code return rr_data}).</li>
 * </ul>
 */
