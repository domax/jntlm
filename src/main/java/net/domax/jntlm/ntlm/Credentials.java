 ...
 *
 * <p>Mirrors CNTLM's {@code struct auth_s}. Holds the identity (user, domain, workstation),
 * the three pre-computed 16-byte password hashes, the dialect switches ({@link #hashNt},
 * {@link #hashLm}, {@link #hashNtlm2}) and an optional manual negotiate-flags override.
 *
 * <p>The dialect switches follow CNTLM semantics:
 * <ul>
 *   <li>{@code hashNtlm2 == 1} &rarr; NTLMv2</li>
 *   <li>{@code hashNt == 2} &rarr; NTLM2 session response (NTLM2SR)</li>
 *   <li>{@code hashNt == 1 && hashLm == 1} &rarr; combined NT+LM (NTLM)</li>
 *   <li>{@code hashNt == 1} &rarr; NT only</li>
 *   <li>{@code hashLm == 1} &rarr; LM only</li>
 * </ul>
 */
