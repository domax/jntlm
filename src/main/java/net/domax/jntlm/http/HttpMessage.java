...
/**
 * An HTTP request or response message (request/status line + headers), analogous to CNTLM's
 * {@code rr_data_t}.
 *
 * <p>A message is either a request (has {@link #method}, {@link #url}) or a response (has
 * {@link #code}, {@link #status}). The HTTP version is stored as an integer, e.g. {@code 11}
 * for {@code HTTP/1.1}, matching CNTLM's {@code http_version} convention.
 */
