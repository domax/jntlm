...
class ProxyForwardingIntegrationTest {
    ...
    void reusesAuthenticatedConnectionForSecondRequest() throws Exception {
        ...
        out.write(("GET http://example.com/b HTTP/1.1\r\n"
                + "Host: example.com\r\n"
        ...
        assertEquals(1, parent.challengesSent(), "second request must reuse the authenticated connection");
    ...
    void tunnelsConnectRequests() throws Exception {
        ...
        // The mock echoes tunnelled bytes back.
